...
public abstract class TextArea extends JPanel
{
	...
	public void selectBlock()
	{
		...
		String openBrackets = "([{Â«â€¹âŸ¨âŒˆâŒŠâ¦‡âŸ¦â¦ƒ";
		String closeBrackets = ")]}Â»â€ºâŸ©âŒ‰âŒ‹â¦ˆâŸ§â¦„";
		int count = 1;
		char openBracket = '\0';
		char closeBracket = '\0';
...
.	 * @param eatWhitespace If true, will eat whitespace
	...
	{
		int caretBack = buffer.addExplicitFold(caretStart, caretEnd, lineStart, lineEnd);
